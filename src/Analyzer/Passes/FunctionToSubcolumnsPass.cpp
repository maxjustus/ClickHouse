...
class GetOuterJoinedTablesVisitor : public MemoizingInDepthQueryTreeVisitorWithContext<GetOuterJoinedTablesVisitor>
{
public:
    using Base = MemoizingInDepthQueryTreeVisitorWithContext<GetOuterJoinedTablesVisitor>;
    using Base::Base;
