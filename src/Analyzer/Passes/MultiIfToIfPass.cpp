...
class MultiIfToIfVisitor : public MemoizingInDepthQueryTreeVisitorWithContext<MultiIfToIfVisitor>
{
public:
    using Base = MemoizingInDepthQueryTreeVisitorWithContext<MultiIfToIfVisitor>;
    using Base::Base;
